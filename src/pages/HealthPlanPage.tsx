  ...
  return (
    <>
        ...
        <div className="container-custom max-w-4xl">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
            ...
            >
              ...
              <h3 className="font-heading font-semibold text-lg mb-2">Complete Profile</h3>
              <p className="text-gray-600">Fill out your health profile with accurate information for better recommendations.</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-heading font-semibold text-lg mb-2">Get Your Plan</h3>
              <p className="text-gray-600">Receive a personalized health plan based on your unique needs and goals.</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-heading font-semibold text-lg mb-2">Expert Guidance</h3>
              <p className="text-gray-600">Access to professional advice and answers to your health questions.</p>
            </motion.div>
          </div>
      ...
      {showPlan && userFormData && (
        <section id="plan-results" className="py-12 md:py-16 bg-gray-50">
          <div className="container-custom max-w-4xl">
