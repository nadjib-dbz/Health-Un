          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="col-span-1">
              <motion.div
                ...
                transition={{ duration: 0.5 }}
              >
                <h2 className="font-heading font-semibold text-xl mb-6">Filter Products</h2>
                <ProductFilters 
            ...
            <div className="col-span-1 lg:col-span-3">
              {displayedProducts.length === 0 ? (
                ...
                >
                  ...
                  <p className="text-gray-600">Try adjusting your filters or browse different categories.</p>
                </motion.div>
              ) : (
                <motion.div 
