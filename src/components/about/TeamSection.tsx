          ...
          {members.map((member, index) => (
            ...
            >
              <div className="p-6 flex flex-col items-center text-center">
                <div className="w-32 h-32 rounded-full overflow-hidden mb-6 shadow-md border-4 border-primary-100 dark:border-primary-900">
                  <img
                ...
                <h3 className="font-heading font-semibold text-xl mb-1 dark:text-white">{member.name}</h3>
